...
def process_pdf(pdf_file, index):
    ...
    json_filename = "{}.json".format(os.path.splitext(os.path.basename(pdf_file))[0])
    ...
    with open(pdf_file, "rb") as file:
        ...
        for i in range(1, npages + 1):
            try:
                ...
                all_messages.append({
                    "page_number": i,
                    "page_content": page_content  # Assume 'page_content' is defined with the OCR text
                })
